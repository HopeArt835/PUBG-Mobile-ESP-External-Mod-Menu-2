...
public class FloatLogo extends Service implements View.OnClickListener {
    ...
    void createOver(){
        ...
        final LinearLayout brut =mFloatingView.findViewById(R.id.brutal);
        final TextView playerBtn=mFloatingView.findViewById(R.id.playerBtn);
        final TextView brtlBtn=mFloatingView.findViewById(R.id.brtlBtn);
        ...
        playerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemBtn.setBackgroundColor(Color.parseColor("#312e43"));
                playerBtn.setBackgroundColor(Color.parseColor("#29cbb6"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#312e43"));
                brtlBtn.setBackgroundColor(Color.parseColor("#312e43"));
                items.setVisibility(View.GONE);
                player.setVisibility(View.VISIBLE);
                vehicle.setVisibility(View.GONE);
                brut.setVisibility(View.GONE);
            }
        });
        ...
        itemBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemBtn.setBackgroundColor(Color.parseColor("#29cbb6"));
                playerBtn.setBackgroundColor(Color.parseColor("#312e43"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#312e43"));
                brtlBtn.setBackgroundColor(Color.parseColor("#312e43"));
        ...
        class onc implements CompoundButton.OnCheckedChangeListener
        {
            @Override
            public void onCheckedChanged(CompoundButton Njay, boolean isChecked)
            {
                switch (Njay.getId())
                {
                    ...
                    case R.id.lessrecoil:
                        if (isChecked)
                        {
                            try {
                                Runtime.getRuntime().exec("su -c /data/data/tggod.doom/files/jni/libavutil.so");
                            } catch (Exception s) {
                            }
                            Toast.makeText(FloatLogo.this, "lessRecoil ON", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            try {
                            ...
                            Toast.makeText(FloatLogo.this, "lessRecoil OFF", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case R.id.aimbotbr:
                        if (isChecked)
                        {
                            try {
                                Runtime.getRuntime().exec("su -c /data/data/tggod.doom/files/jni/AimBotON");
                            } catch (Exception s) {
                            }
                            Toast.makeText(FloatLogo.this, "AimBot ON", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            try {
                                Runtime.getRuntime().exec("su -c /data/data/tggod.doom/files/AimBotOff");
                            } catch (Exception s) {
                            }
                            Toast.makeText(FloatLogo.this, "AimBot OFF", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case R.id.headshoot:
                        if (isChecked)
                        {
                            try {
                                Runtime.getRuntime().exec("su -c /data/data/tggod.doom/files/headshootON");
                            } catch (Exception s) {
                            }
                            Toast.makeText(FloatLogo.this, "headshoot ON", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            try {
                                Runtime.getRuntime().exec("su -c /data/data/tggod.doom/files/headshootOFF");
                            } catch (Exception s) {
                                s.printStackTrace();
                            }
                            Toast.makeText(FloatLogo.this, "headshoot OFF", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case R.id.speed:
                        if (isChecked)
                        {
                            try {
                                Runtime.getRuntime().exec("su -c /data/data/tggod.doom/files/SpeedRunON");
                            } catch (Exception ignored) {
                            }
                            Toast.makeText(FloatLogo.this, "SpeedRun ON", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            try {
                                Runtime.getRuntime().exec("su -c /data/data/tggod.doom/files/SpeedRunOff");
                            } catch (Exception s) {
                            }
                            Toast.makeText(FloatLogo.this, "SpeedRun OFF", Toast.LENGTH_SHORT).show();
                        }
                        break;
                }
        ...
        vehicleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                itemBtn.setBackgroundColor(Color.parseColor("#312e43"));
                playerBtn.setBackgroundColor(Color.parseColor("#312e43"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#29cbb6"));
                brtlBtn.setBackgroundColor(Color.parseColor("#312e43"));
                items.setVisibility(View.GONE);
                player.setVisibility(View.GONE);
        ...
        brtlBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemBtn.setBackgroundColor(Color.parseColor("#312e43"));
                playerBtn.setBackgroundColor(Color.parseColor("#312e43"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#312e43"));
                brtlBtn.setBackgroundColor(Color.parseColor("#29cbb6"));
                items.setVisibility(View.GONE);
                player.setVisibility(View.GONE);
                vehicle.setVisibility(View.GONE);
                brut.setVisibility(View.VISIBLE);
            }
        });
    ...
    public int getStrokeCrosHair() {
        return getSharedPreferences("espValue", 0).getInt("StrokeCrosHair", ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION);
    }
    ...
    public int getStrokeBox() {
        return getSharedPreferences("espValue", 0).getInt("StrokeBox", 0);
    }

     
    public int getStrokeSkeleton() {
        return getSharedPreferences("espValue", 0).getInt("StrokeSkeleton", 0);
    }
    ...
    void Init(){
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                FloatLogo.this.AimBy(Integer.parseInt(((RadioButton) FloatLogo.this.mFloatingView.findViewById(radioGroup.getCheckedRadioButtonId())).getTag().toString()));
            }
        });
        final RadioGroup radioGroup2 = (RadioGroup) this.mFloatingView.findViewById(R.id.aimwhen);
        radioGroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                FloatLogo.this.AimWhen(Integer.parseInt(((RadioButton) FloatLogo.this.mFloatingView.findViewById(radioGroup2.getCheckedRadioButtonId())).getTag().toString()));
            }
        });
        final RadioGroup radioGroup3 = (RadioGroup) this.mFloatingView.findViewById(R.id.aimbotmode);
        radioGroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                FloatLogo.this.Target(Integer.parseInt(((RadioButton) FloatLogo.this.mFloatingView.findViewById(radioGroup3.getCheckedRadioButtonId())).getTag().toString()));
            }
        });
        @SuppressLint("UseSwitchCompatOrMaterialCode") final Switch switchR11 = (Switch) this.mFloatingView.findViewById(R.id.aimbot);
        switchR11.setChecked(getConfig(((String) switchR11.getText()) + "float"));
        if (getConfig("Aimbotfloat")) {
            getApplicationContext().startService(new Intent(getApplicationContext(), FloatAim.class));
        } else {
        ...
        switchR11.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                FloatLogo.this.setValue("Aimbotfloat", switchR11.isChecked());
                if (FloatLogo.this.getConfig("Aimbotfloat")) {
                    FloatLogo.this.getApplicationContext().startService(new Intent(FloatLogo.this.getApplicationContext(), FloatAim.class));
                    return;
                }
                FloatLogo.this.getApplicationContext().stopService(new Intent(FloatLogo.this.getApplicationContext(), FloatAim.class));
            }
        });
        @SuppressLint("UseSwitchCompatOrMaterialCode") Switch switchR12 = (Switch) this.mFloatingView.findViewById(R.id.aimknocked);
        ...
        lessrecoil.setChecked(getConfig((String) lessrecoil.getText()));
        SettingValue(9,getConfig((String) lessrecoil.getText()));
        lessrecoil.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                setValue(String.valueOf(lessrecoil.getText()), lessrecoil.isChecked());
                SettingValue(9,lessrecoil.isChecked());
            }
        });
